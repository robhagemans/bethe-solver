...
public:
    ...
    String(const int big_n, const int string_length, const int sum_jx2);
...
public:
    ...
    void setPolicy(const double initial_deviation=0.0625 /*1e-20*/, const double damping_delta=0.5);
    // introduce knock outs - 0= no knockouts, 1=inner pair (or centre), 2=two pairs (or pair and centre), etc..
    bool knockOut(const int number_pairs=0);
